...
class Calculator extends WindowAdapter implements ActionListener 
{
    ...
    public JButton b1, b2, b3, b4;     //reference of button
    ...
    public Calculator(int width, int height, String Title)
    {
        ...
        b1.setBounds(10,280,80,40);  //parameters are x coordinate, y coordinate, w coordinate, h coordinate
        ...
        b1.addActionListener(this);         //button la listeners lavle 
